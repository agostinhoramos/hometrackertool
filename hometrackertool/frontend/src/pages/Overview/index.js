...
const subNavigation = [
  { name: 'Overview', href: '#', icon: UserCircleIcon, current: true },
  { name: 'Log', href: '#', icon: CogIcon, current: false },
  { name: 'History', href: '#', icon: KeyIcon, current: false },
  { name: 'Developer Tools', href: '#', icon: BellIcon, current: false },
  { name: 'Configuration', href: '#', icon: CreditCardIcon, current: false },
  { name: 'Notification', href: '#', icon: ViewGridAddIcon, current: false },
]
