...
const navigation = [
	...
	{ name: 'Profiles', showText: true, link: '/profiles', icon: UsersIcon },
    //{ name: 'Rule Chains', showText: true, link: '/rule_chains', icon: CursorClickIcon },
    //{ name: 'Scheduler', showText: true, link: '/scheduler', icon: CalendarIcon },
    //{ name: 'Integrations', showText: true, link: '/integrations', icon: ChipIcon },
    { name: 'Settings', showText: true, link: '/settings', icon: CogIcon },
	{ name: 'About', showText: true, link: '/about', icon: InformationCircleIcon },
]
